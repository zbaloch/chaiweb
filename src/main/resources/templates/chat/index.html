                                                            ...
                                                            <div class="flex items-start mb-4 text-sm" id="chat_message_${chatMessage.id}">
                                                                ...
                                                                <div class="flex-1 overflow-hidden">
                                                                    <div class="flex justify-between">
                                                                        ...
                                                                        <div>
                                                                            <c:if test="${chatMessage.user.id == sessionScope.current_user.id}">
                                                                                <a v-on:click.stop="deleteChatMessage(${project.id}, ${chatMessage.id})" class="underline text-red-500 cursor-pointer ">
