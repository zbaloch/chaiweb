    ...
    <div class="max-w-4xl mx-auto px-2 sm:px-4 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class=" hidden lg:ml-4 lg:flex lg:items-center">
                ...
                <a href="${contextUrl}/hey" class="inline-block relative flex-shrink-0 px-1 border-2 border-transparent text-gray-400 rounded-full hover:text-gray-500 focus:outline-none focus:text-gray-500 focus:bg-gray-100 transition duration-150 ease-in-out" aria-label="Notifications">
                    <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/>
                    </svg>
                    <span v-cloak v-if="hasUnreadNotifications" class="absolute right-10px top-5px block h-2.5 w-2.5 transform -translate-y-1/2 translate-x-1/2 rounded-full bg-red-500"></span>
                </a>
