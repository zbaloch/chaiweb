        ...
        <div class="py-10">
            <div class="max-w-4xl mx-auto px-4 sm:px-4 lg:px-4">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div data-controller="nav" class="relative">
                                <button class="text-gray-800 font-bold z-10 relative" data-action="click -> nav#toggleProjectActions">
                                    <svg class="fill-current w-4 h-4 mr-2" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 20 20" stroke="currentColor">
                    ...
                    <button type="button" class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 text-xs leading-4 font-medium rounded-full text-gray-700 bg-white hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:text-gray-800 active:bg-gray-50 transition ease-in-out duration-150">
                      Add/remove people
                    </button>
                  </span>
                        ...
                        <div class="mb-8 mt-8">
                            <div class="flex flex-wrap -mx-3">
                                <div class="w-full md:w-1/2 lg:w-1/3 px-3 flex flex-col mb-8">
                                    <a class="no-underline bg-white rounded-lg shadow-lg hover:shadow-raised hover:translateY-2px transition flex-1 flex flex-col overflow-hidden" href="/projects/1">
                                        <div class="p-6 flex flex-col">
                                            <h3 class="font-display text-black no-underline mb-2 font-bold">Chat</h3> <!-- TODO: Seed the HQ by default-->
