                    ...
                    <form:form modelAttribute="todo">
                                ...
                                <div class="mt-6 grid grid-cols-1 row-gap-6 col-gap-4 sm:grid-cols-6">
                                        ...
                                        <div class="mt-1 rounded-md shadow-sm">
                                            <form:select path="assignedToVariable" id="location" class="mt-1 form-select block w-full pl-3 pr-10 py-2 text-base leading-6 border-gray-300 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5">
                                                <c:forEach items="${project.users}" var="user">
                                                    <c:if test="${todo.assignedTo.id == user.id}">
                                                ...
                                                <c:if test="${todo.assignedTo.id == sessionScope.current_user.id}">
                                                    <option value="${sessionScope.current_user.id}" selected>${sessionScope.current_user.firstName} ${sessionScope.current_user.lastName}</option>
                                                </c:if>
                                                <c:if test="${todo.assignedTo.id != sessionScope.current_user.id}">
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-1 rounded-md shadow-sm">
                                            ...
                                            <input type="date" data-date="" id="dueDateVariable" name="dueDateVariable"
                        ...
                        <div class="mt-8 border-t border-gray-200 pt-5">
                            ...
                            <span class="inline-flex rounded-md shadow-sm">
                                <a href="${contextUrl}/project/${project.id}/todo/${todo.id}/delete"
