...
<%--
<div v-if="showAvatarModal" class="absolute min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 ">

    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">

        <li class="flex flex-col text-center bg-white rounded-lg shadow">
